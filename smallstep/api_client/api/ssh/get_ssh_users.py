    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        ...
        for response_200_item_data in _response_200:
            response_200_item = SSHUser.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    """List SSH Users
     ...
     List the users that have been synced from your identity provider's directory.
    If your team has not configured an external identity provider this will return users from the
