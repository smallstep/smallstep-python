...
from ...models.list_accounts_pagination_type_0 import ListAccountsPaginationType0
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    pagination: Union["ListAccountsPaginationType0", None, Unset] = UNSET,
    ...
    elif isinstance(pagination, ListAccountsPaginationType0):
...
def sync_detailed(
    *,
    ...
    Args:
        pagination (Union['ListAccountsPaginationType0', None, Unset]):
