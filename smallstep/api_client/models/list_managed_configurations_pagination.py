...
T = TypeVar("T", bound="ListManagedConfigurationsPagination")


@_attrs_define
class ListManagedConfigurationsPagination:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_managed_configurations_pagination = cls(
            after=after,
            first=first,
        )

        list_managed_configurations_pagination.additional_properties = d
        return list_managed_configurations_pagination
