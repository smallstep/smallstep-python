...
T = TypeVar("T", bound="GetSshGroupsPaginationType0")


@_attrs_define
class GetSshGroupsPaginationType0:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_ssh_groups_pagination_type_0 = cls(
            after=after,
            first=first,
        )

        get_ssh_groups_pagination_type_0.additional_properties = d
