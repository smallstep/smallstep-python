...
T = TypeVar("T", bound="ListCollectionsPagination")


@_attrs_define
class ListCollectionsPagination:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_collections_pagination = cls(
            after=after,
            first=first,
        )

        list_collections_pagination.additional_properties = d
        return list_collections_pagination
