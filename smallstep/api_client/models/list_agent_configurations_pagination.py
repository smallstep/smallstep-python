...
T = TypeVar("T", bound="ListAgentConfigurationsPagination")


@_attrs_define
class ListAgentConfigurationsPagination:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_agent_configurations_pagination = cls(
            after=after,
            first=first,
        )

        list_agent_configurations_pagination.additional_properties = d
        return list_agent_configurations_pagination
