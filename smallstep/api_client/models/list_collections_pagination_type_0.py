...
T = TypeVar("T", bound="ListCollectionsPaginationType0")


@_attrs_define
class ListCollectionsPaginationType0:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_collections_pagination_type_0 = cls(
            after=after,
            first=first,
        )

        list_collections_pagination_type_0.additional_properties = d
        return list_collections_pagination_type_0
