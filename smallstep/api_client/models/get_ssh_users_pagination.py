...
T = TypeVar("T", bound="GetSshUsersPagination")


@_attrs_define
class GetSshUsersPagination:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_ssh_users_pagination = cls(
            after=after,
            first=first,
        )

        get_ssh_users_pagination.additional_properties = d
        return get_ssh_users_pagination
