...
T = TypeVar("T", bound="GetSshHostTagsPagination")


@_attrs_define
class GetSshHostTagsPagination:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_ssh_host_tags_pagination = cls(
            after=after,
            first=first,
        )

        get_ssh_host_tags_pagination.additional_properties = d
        return get_ssh_host_tags_pagination
