...
from ..models.post_auth_body_audience import PostAuthBodyAudience
from ..types import UNSET, File, FileJsonType, Unset

T = TypeVar("T", bound="PostAuthBody")
...
class PostAuthBody:
    """
    Attributes:
        audience (Union[Unset, PostAuthBodyAudience]):
        bundle (Union[Unset, List[File]]):
        team_id (Union[Unset, str]):
        team_slug (Union[Unset, str]):
    """

    audience: Union[Unset, PostAuthBodyAudience] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_audience, Unset):
            ...
            audience = PostAuthBodyAudience(_audience)
        ...
        post_auth_body.additional_properties = d
        return post_auth_body
