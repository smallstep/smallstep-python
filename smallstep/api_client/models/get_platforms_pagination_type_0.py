...
T = TypeVar("T", bound="GetPlatformsPaginationType0")


@_attrs_define
class GetPlatformsPaginationType0:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_platforms_pagination_type_0 = cls(
            after=after,
            first=first,
        )

        get_platforms_pagination_type_0.additional_properties = d
        return get_platforms_pagination_type_0
