...
T = TypeVar("T", bound="GetSshHostsPagination")


@_attrs_define
class GetSshHostsPagination:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_ssh_hosts_pagination = cls(
            after=after,
            first=first,
        )

        get_ssh_hosts_pagination.additional_properties = d
        return get_ssh_hosts_pagination
