...
T = TypeVar("T", bound="GetSshHostTagsPaginationType0")


@_attrs_define
class GetSshHostTagsPaginationType0:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_ssh_host_tags_pagination_type_0 = cls(
            after=after,
            first=first,
        )

        get_ssh_host_tags_pagination_type_0.additional_properties = d
        return get_ssh_host_tags_pagination_type_0
