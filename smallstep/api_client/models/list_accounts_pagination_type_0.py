...
T = TypeVar("T", bound="ListAccountsPaginationType0")


@_attrs_define
class ListAccountsPaginationType0:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_accounts_pagination_type_0 = cls(
            after=after,
            first=first,
        )

        list_accounts_pagination_type_0.additional_properties = d
