...
T = TypeVar("T", bound="ListCollectionInstancesPagination")
...
class ListCollectionInstancesPagination:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_collection_instances_pagination = cls(
            after=after,
            first=first,
        )

        list_collection_instances_pagination.additional_properties = d
        return list_collection_instances_pagination
