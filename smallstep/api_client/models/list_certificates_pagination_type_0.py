...
T = TypeVar("T", bound="ListCertificatesPaginationType0")


@_attrs_define
class ListCertificatesPaginationType0:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_certificates_pagination_type_0 = cls(
            after=after,
            first=first,
        )

        list_certificates_pagination_type_0.additional_properties = d
